...
// CONCATENATED MODULE: /Users/apoorv/khare/Radicali/meetmica-v2/node_modules/common/src/containers/Crypto/ControlSection2/controlSection.style.js
...
var hardesh_default = /*#__PURE__*/__webpack_require__.n(hardesh);
...
var shubhankar_default = /*#__PURE__*/__webpack_require__.n(shubhankar);
...
// CONCATENATED MODULE: /Users/apoorv/khare/Radicali/meetmica-v2/node_modules/common/src/containers/Crypto/ControlSection2/index.js
...
var ControlSection2_Completionist = function Completionist() {
  return external_react_default.a.createElement("span", {
    className: "readMore"
  }, "You are good to go!");
};

var ControlSection2_renderer = function renderer(_ref) {
  var days = _ref.days,
      hours = _ref.hours,
  ...
  if (completed) {
    ...
    return external_react_default.a.createElement(ControlSection2_Completionist, null);
  } else {
    // Render a countdown
    return external_react_default.a.createElement("div", {
...
var ControlSection2_ControlSection = function ControlSection(_ref2) {
  var row = _ref2.row,
      col = _ref2.col,
      title = _ref2.title,
  ...
  return external_react_default.a.createElement(ControlWrapper, {
    ...
    className: "colright"
  }, col), external_react_default.a.createElement(Box["a" /* default */], Object(esm_extends["a" /* default */])({
    className: "row"
  }, row, {
    style: {
      flexDirection: 'column'
    ...
    src: hardesh_default.a,
    className: "controlImage",
    alt: "Control Section Image"
  })), external_react_default.a.createElement(Box["a" /* default */], Object(esm_extends["a" /* default */])({
    className: "row"
  }, row, cardArea), external_react_default.a.createElement(FeatureBlock["a" /* default */], {
    title: external_react_default.a.createElement(Heading["a" /* default */], title)
...
ControlSection2_ControlSection.defaultProps = {
...
/* harmony default export */ var ControlSection2 = (ControlSection2_ControlSection);
...
// CONCATENATED MODULE: /Users/apoorv/khare/Radicali/meetmica-v2/node_modules/common/src/containers/Crypto/BetaSection2/betaSection.style.js
...
var BetaSectionWrapper = external_styled_components_default.a.section.withConfig({
  ...
  componentId: "fluvz3-0"
})(["padding:30px 0 100px;margin-top:100px;width:60vw;margin-left:20vw;@media (max-width:420px){justify-content:space-between;align-items:center;margin:100px 0px 0px 0px;width:100%;padding-left:10px;padding-right:10px;}"]);
var betaSection_style_FeatureSection = external_styled_components_default.a.section.withConfig({
  displayName: "betaSectionstyle__FeatureSection",
  componentId: "fluvz3-1"
})(["display:flex;flex-wrap:wrap;justify-content:space-around;align-items:center;@media (max-width:768px){justify-content:space-between;align-items:flex-start;}.featureWrapper{margin-top:50px;display:flex;@media (max-width:599px){max-width:100%;}@media (max-width:420px){align-items:center}img{width:120px;height:100px;object-fit:contain;margin-bottom:20px;border-width:2px;border-color:rgb(233,227,254);border-radius:10px;background-color:rgb(243,242,250);padding:8px 10px;}.contextPortion{margin-left:15px;}}"]);

// CONCATENATED MODULE: /Users/apoorv/khare/Radicali/meetmica-v2/node_modules/common/src/containers/Crypto/BetaSection2/index.js
...
var BetaSection2_BetaSection = function BetaSection(_ref) {
  var row = _ref.row,
      title = _ref.title,
      title2 = _ref.title2,
      button = _ref.button,
...
// Trusted default style
BetaSection2_BetaSection.defaultProps = {
  // Trusted section row default style
  row: (_row = {
    flexBox: true,
    flexWrap: 'wrap',
  ...
  title: {
    content: 'Our mission: to help make compliance teams ridiculously efficient',
    fontSize: ['24px', '26px', '30px', '36px', '40px'],
    lineHeight: ['30px', '32px', '40px', '50px', '55px'],
    fontWeight: '700',
    color: '#32325d',
  ...
  description: {
    content: '- Hardesh Singh, Co-Founder & CEO',
    fontSize: '16px',
    fontWeight: '700',
    color: '#32325d',
    lineHeight: '28px',
...
/* harmony default export */ var BetaSection2 = (BetaSection2_BetaSection);
...
// CONCATENATED MODULE: /Users/apoorv/khare/Radicali/meetmica-v2/node_modules/common/src/containers/Crypto/FeatureSection_2/featureSection.style.js
...
// CONCATENATED MODULE: /Users/apoorv/khare/Radicali/meetmica-v2/node_modules/common/src/containers/Crypto/FeatureSection_2/index.js
...
var FeatureSection_2_FeatureSection = function FeatureSection(_ref) {
  var row = _ref.row,
      col = _ref.col,
      ...
      featureTitle2 = _ref.featureTitle2,
  ...
  return external_react_default.a.createElement(featureSection_style, {
    ...
    className: "row"
  }, row), Crypto["c" /* Features2 */].map(function (feature, index) {
...
FeatureSection_2_FeatureSection.defaultProps = {
...
/* harmony default export */ var FeatureSection_2 = (FeatureSection_2_FeatureSection);
